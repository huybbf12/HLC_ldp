...
1. Đưa toàn bộ nội dung thư mục này lên một repository GitHub, gồm `index.html`, `vercel.json`, `README-DEPLOY.md` và thư mục `assets/`.
...
- Logo navbar đã được đóng gói cục bộ tại `assets/images/brand/`.
